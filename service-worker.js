...
const ASSETS = [
  ...
  './js/curriculum/world-maps.js', './js/curriculum/toys-data.js', './js/curriculum/missions-data.js', './js/curriculum/quests-data.js', './js/curriculum/seasonal-data.js',
